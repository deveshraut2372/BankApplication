...
import com.zplus.payload.response.FileUploadResDto;
...
public class FileHandlingController {
    ...
    public ResponseEntity fileHandelDemo(@RequestParam(value = "uploadfile") MultipartFile file) throws Exception {
        ...
        if (extension.equalsIgnoreCase("png") || extension.equalsIgnoreCase("jpg") || extension.equalsIgnoreCase("gif") || extension.equalsIgnoreCase("jpeg") || extension.equalsIgnoreCase("pdf") || extension.equalsIgnoreCase("docx") || extension.equalsIgnoreCase("mp4") ||extension.equalsIgnoreCase("xlsx") ||extension.equalsIgnoreCase("xls")) {
